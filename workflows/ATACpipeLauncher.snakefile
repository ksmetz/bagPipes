...
newSamplesheet = ('output/{name}_ATACpipeSamplesheet.txt').format(name = runName)
...
if config['mergeBy'] == config['fileNamesFrom'] or config['mergeBy'] == '':
	...
	include: "ATACpipeMerged.snakefile"

## Define actions on success
onsuccess:
	## Success message
	print("ATACpipe completed successfully! Wahoo!")
